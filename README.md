...
|------|------|
| `setup.ps1` | 工具入口脚本 |
| `modules/` | 安装、配置、provider 管理、卸载等功能模块 |
| `README.md` | 使用说明 |
| `LICENSE` | 开源许可证 |
| `.gitignore` | 防止日志、下载包、本机配置和密钥类文件误上传 |
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\setup.ps1 -InstallDir "E:\ClaudeCodeCLI"
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\setup.ps1 -Model deepseek
powershell -NoProfile -ExecutionPolicy Bypass -File .\setup.ps1 -Model kimi/kimi-k2.5
powershell -NoProfile -ExecutionPolicy Bypass -File .\setup.ps1 -Model kimi26/kimi-for-coding
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\setup.ps1 -Uninstall -InstallDir "E:\ClaudeCodeCLI"
```
